...
import FRAMES_JSON from "@/data/ascii-frames/moon-knight-mr-knight-frames.json";
...
export default function MoonKnightMrKnight() {
        ...
        >
          {(() => {
            ...
            if (currentBatch !== "") {
              result.push(
                isBatchAffected ? (
                  <span key="final" className={effectClass} style={effectStyle}>
                    {currentBatch}
                  </span>
                ) : (
                  currentBatch
