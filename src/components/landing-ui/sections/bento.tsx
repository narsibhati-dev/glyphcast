...
const Bento = () => {
  return (
    <div className="flex flex-col text-center justify-center items-center">
      ...
      <motion.div
        className="landing-content-width mt-8 grid h-auto grid-cols-1 gap-4 md:mt-10 sm:grid-cols-12 sm:grid-rows-2"
      ...
      >
        <motion.div
          variants={bentoRow}
          className="relative sm:col-span-6 sm:row-start-1"
          style={{
            background: "#FFF3EC",
        ...
        <motion.div
          variants={bentoRow}
          className="relative p-4 sm:col-span-6 sm:row-start-1 sm:p-6"
          style={{
            background: "#FFF3EC",
            border: "1px solid #FFD0AC",
            boxShadow:
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            ...
            <div className="flex w-full flex-col items-start text-left">
              ...
              <span className="text-[11px] font-medium text-[#666666] sm:text-xs">
                Download stills, MP4, or a drop-in component, one click from the
                preview you already trust.
              </span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          variants={bentoRow}
          className="relative flex h-full min-h-0 flex-col p-4 sm:col-span-7 sm:row-start-2 sm:p-6"
          style={{
            border: "1px solid #FFD0AC",
            boxShadow:
              "0px 4px 16px rgba(181,75,0,0.08), 0px 1px 3px rgba(181,75,0,0.06)",
        ...
        >
          ...
          <div className="relative z-10 flex h-full min-h-0 w-full flex-col text-left">
            ...
            <span className="mt-1.5 shrink-0 text-[11px] font-medium text-[#666666] sm:text-xs">
              The split preview keeps source and text conversion aligned: hover
              to scroll the strip and read the final rhythm before you ship the
              sequence.
            </span>
            <div className="z-20 flex min-h-0 w-full flex-1 items-center justify-center pt-4 sm:pt-5">
              <PortalMarqueeTransform
                ...
                className="h-full w-full min-h-[160px] max-h-[220px] flex-1 rounded-2xl border border-transparent bg-transparent shadow-none sm:min-h-[170px] sm:max-h-[240px]"
              />
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          variants={bentoRow}
          className="relative flex flex-col justify-between overflow-hidden p-4 sm:col-span-5 sm:row-start-2 sm:p-6"
          style={{
            background:
